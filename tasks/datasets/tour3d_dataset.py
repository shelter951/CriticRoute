...
if __name__=='__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default='configs/pretrain.yaml', help='dataset configs')
    parser.add_argument('--pretrained_model_name_or_path', default='data/models/Vicuna-7B', type=str, help="path to tokenizer")
