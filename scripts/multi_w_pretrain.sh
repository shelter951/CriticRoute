...
# ${TORCHRUN:-torchrun} --nnodes=1 --nproc_per_node=8 --master_port 19923 train.py \
#     --stage multi --cfg_file configs/multi.yaml \
#     --data_dir ${DATA_DIR:-data} --pretrained_model_name_or_path data/models/Vicuna-7B --precision amp_bf16 \
...
${TORCHRUN:-torchrun} --nproc_per_node=8 --master_port=19327 tools/occu_full.py 
