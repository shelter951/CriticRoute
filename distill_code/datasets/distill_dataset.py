...
from tasks.feature_db import ImageFeaturesDB, create_feature_db
from tasks.datasets.mp3d_envs import angle_feature
...
class DistillDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Assert label is within valid range
        assert 0 <= label < len(cand_vpids), \
            f"Invalid label {label} for {len(cand_vpids)} candidates in episode {sample['episode_id']}, step {sample['step_t']}"
