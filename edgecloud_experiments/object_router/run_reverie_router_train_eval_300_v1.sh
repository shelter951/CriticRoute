...
OUT=$ROOT/build/object_router/reverie_router_train_300_v1
...
echo "START REVERIE router train/eval $(date)" | tee -a "$OUT/pipeline.log"
...
echo "FINISH REVERIE router train/eval $(date)" | tee -a "$OUT/pipeline.log"
